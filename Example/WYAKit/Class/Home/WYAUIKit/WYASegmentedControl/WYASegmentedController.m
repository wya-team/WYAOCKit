...
@property (nonatomic, strong) WYASegmentedControl * segmentedControl4;@end
...
- (WYASegmentedControl *)segmentedControl1{
    if(!_segmentedControl1){
        _segmentedControl1 = ({
            CGRect frame = CGRectMake(10*SizeAdapter, CGRectGetMaxY(self.titleLabel1.frame) + 10*SizeAdapter, ScreenWidth-20*SizeAdapter, 40);
...
- (WYASegmentedControl *)segmentedControl2{
    if(!_segmentedControl2){
        _segmentedControl2 = ({
            CGRect frame = CGRectMake(10*SizeAdapter, 10*SizeAdapter + CGRectGetMaxY(self.titleLabel2.frame), ScreenWidth-20*SizeAdapter, 40);
            WYASegmentedControl * object = [WYASegmentedControl wya_initWithFrame:frame itemsTitleArray:@[@"segment1",@"segment2"]];
            object.delegate = self;
...
- (WYASegmentedControl *)segmentedControl3{
    if(!_segmentedControl3){
        _segmentedControl3 = ({
            WYASegmentedControl * object = [WYASegmentedControl wya_initWithFrame:CGRectMake(10*SizeAdapter, CGRectGetMaxY(self.titleLabel3.frame)+10*SizeAdapter, ScreenWidth - 20*SizeAdapter, 40) itemsTitleArray:@[@"segment1",@"segment2",@"segment3",@"segment4"]];
            object.delegate = self;
...
- (UILabel *)titleLabel4{
    if(!_titleLabel4){
        _titleLabel4 = ({
            UILabel * object = [[UILabel alloc]initWithFrame:CGRectMake(10*SizeAdapter, CGRectGetMaxY(self.segmentedControl3.frame)+ 10*SizeAdapter, ScreenWidth-20*SizeAdapter, 30)];
...
- (WYASegmentedControl *)segmentedControl4{
    if(!_segmentedControl4){
        _segmentedControl4 = ({
            WYASegmentedControl * object = [WYASegmentedControl wya_initWithFrame:CGRectMake(10*SizeAdapter, CGRectGetMaxY(self.titleLabel4.frame)+10*SizeAdapter, ScreenWidth - 20*SizeAdapter, 40) itemsTitleArray:@[@"segment1",@"segment2",@"segment3"]];
            object.delegate = self;
