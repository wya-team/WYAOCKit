...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    switch (section) {
        case 0: {
            ...
            cell.model            = [[self.dataSource wya_safeObjectAtIndex:section]
        ...
        case 2: {
            ...
            WYATextListModel * model = [[self.dataSource wya_safeObjectAtIndex:section]
                wya_safeObjectAtIndex:indexPath.row];
            cell.model = model;
            return cell;
        } break;
        case 3: {
            ...
            WYAListCellModel * model = [[self.dataSource wya_safeObjectAtIndex:section]
                wya_safeObjectAtIndex:indexPath.row];
            cell.model = model;
            return cell;
        } break;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 1) { return 65 * SizeAdapter; }
...
- (NSArray *)dataSource {
    if (!_dataSource) {
        _dataSource = ({
            NSArray * object = @[
                [self createModelOneArray],
                [self createModelTwoArray],
                [self createModelThreeArray],
                [self createModelfourArray]
            ];
            object;
        });
    }
...
- (NSArray *)createModelOneArray {
    ...
    WYAListModel * model1 = [WYAListModel modelWith:0
                                          iconNamed:@"icon_list"
                                        titleString:@"标题文字"
                                        rightString:nil
                                    arrowImageNamed:@"jiantou"];
    WYAListModel * model2 = [WYAListModel modelWith:2
                                          iconNamed:@"icon_list"
                                        titleString:@"标题文字"
                                        rightString:nil
                                    arrowImageNamed:nil];
    WYAListModel * model3 = [WYAListModel modelWith:0
                                          iconNamed:@"icon_list"
                                        titleString:@"标题文字"
                                        rightString:nil
                                    arrowImageNamed:@"jiantou"];
    WYAListModel * model4 = [WYAListModel modelWith:1
                                          iconNamed:@"icon_list"
                                        titleString:@"标题文字"
                                        rightString:@"详细信息"
                                    arrowImageNamed:@"jiantou"];
...
- (NSArray *)createModelTwoArray {
    NSMutableArray * array      = [NSMutableArray array];
    WYATwoRowListModel * model1 = [WYATwoRowListModel modelWith:1
                                                      iconNamed:nil
                                                    titleString:@"双行列表"
                                                 subTitleString:@"描述信息"
                                                    rightString:@"详细信息"
    ...
    WYATwoRowListModel * model2 = [WYATwoRowListModel modelWith:0
                                                      iconNamed:@"icon_list"
                                                    titleString:@"双行列表"
                                                 subTitleString:@"描述信息"
                                                    rightString:@"详细信息"
...
- (NSArray *)createModelThreeArray {
    ...
    WYATextListModel * model1 = [WYATextListModel modelWith:0
                                                titleString:@"单行列表"
                                                 rightImage:@"icon_list"
                                                rightString:nil
                                            arrowImageNamed:@"jiantou"];

    WYATextListModel * model2 = [WYATextListModel modelWith:1
                                                titleString:@"单行列表"
                                                 rightImage:nil
                                                rightString:@"我是描述信息"
                                            arrowImageNamed:@"jiantou"];
...
- (NSArray *)createModelfourArray {
    NSMutableArray * array    = [NSMutableArray array];
    WYAListCellModel * model1 = [WYAListCellModel modelWith:0
                                                  iconNamed:nil
                                                titleString:@"单项"
                                            arrowImageNamed:@"icon_list_selected"];
    WYAListCellModel * model2 = [WYAListCellModel modelWith:0
                                                  iconNamed:nil
                                                titleString:@"单项"
                                            arrowImageNamed:@"icon_list_selected"];
    WYAListCellModel * model3 = [WYAListCellModel modelWith:1
                                                  iconNamed:@"icon_radio_selected"
                                                titleString:@"多项选择"
                                            arrowImageNamed:nil];
    WYAListCellModel * model4 = [WYAListCellModel modelWith:1
                                                  iconNamed:@"icon_radio_selected"
                                                titleString:@"多项选择"
                                            arrowImageNamed:nil];
    WYAListCellModel * model5 = [WYAListCellModel modelWith:2
                                                  iconNamed:@"icon_subtract_enable"
                                                titleString:@"标题文字"
                                            arrowImageNamed:@"jiantou"];
    WYAListCellModel * model6 = [WYAListCellModel modelWith:2
                                                  iconNamed:@"icon_subtract_enable"
                                                titleString:@"标题文字"
                                            arrowImageNamed:@"jiantou"];
    [array wya_safeAddObject:model1];
