...
@interface WYAInputItemCellController () <UITableViewDelegate, UITableViewDataSource,
                                          WYAInputItemTwoCellDelegate, WYAInputOneCellDelegate>
    ...
    switch (section) {
        case 0: {
            ...
            if (![model.type isEqualToString:@"2"]) {
                ...
                if (indexPath.row == 2) {
                    [oneCell.rightButton setTitleColor:WYA_RGB_COLOR(16, 142, 233)
            ...
            if (![model.type isEqualToString:@"2"]) {
                ...
                if (indexPath.row == 0) {
                    [oneCell.textFiled wya_setPlaceholedr:model.TextFiledText
                                                    color:[UIColor blackColor]
                                                     font:14];
                    [oneCell.rightButton setTitleColor:[UIColor blackColor]
                                              forState:UIControlStateNormal];
                }
                if (indexPath.row == 1) {
                    [oneCell.textFiled wya_setPlaceholedr:model.TextFiledText
                                                    color:[UIColor blackColor]
                                                     font:14];
                    [oneCell.rightButton setTitleColor:[UIColor grayColor]
                                              forState:UIControlStateNormal];
                }
                return oneCell;
            } else {
...
- (NSArray *)createModelOneArray {
    ...
    WYAInputItemModel * model1 = [WYAInputItemModel modelWithTitle:@"标签"
                                                     textFiledText:@"输入内容"
                                                instructionsString:@"右侧注释"
                                                              type:@"0"
                                                        imageNamed:nil];

    WYAInputItemModel * model2 = [WYAInputItemModel modelWithTitle:@"标签"
                                                     textFiledText:@"我是暗提示"
                                                instructionsString:nil
                                                              type:@"1"
                                                        imageNamed:@"icon_eye"];

    WYAInputItemModel * model3 = [WYAInputItemModel modelWithTitle:@"标签"
                                                     textFiledText:@"我是暗提示"
                                                instructionsString:@"使用说明"
                                                              type:@"0"
                                                        imageNamed:nil];

    WYAInputItemModel * model4 = [WYAInputItemModel modelWithTitle:@"标签"
                                                     textFiledText:@"我是暗提示"
                                                instructionsString:nil
                                                              type:@"1"
                                                        imageNamed:@"icon_arrow"];

    WYAInputItemModel * model5 = [WYAInputItemModel modelWithTitle:@"标签"
                                                     textFiledText:@"我是暗提示"
                                                instructionsString:@"右侧注释"
                                                              type:@"2"
                                                        imageNamed:@"icon_arrow"];
...
- (NSArray *)createModelTwoArray {
    ...
    WYAInputItemModel * model2 = [WYAInputItemModel modelWithTitle:@"银行卡"
                                                     textFiledText:@"1212 1675 1268 2245"
                                                instructionsString:nil
                                                              type:@"3"
                                                        imageNamed:nil];

    WYAInputItemModel * model3 = [WYAInputItemModel modelWithTitle:@"密码"
                                                     textFiledText:@"123456"
                                                instructionsString:nil
                                                              type:@"1"
                                                        imageNamed:@"icon_eye"];

    WYAInputItemModel * model4 = [WYAInputItemModel modelWithTitle:@"金额"
                                                     textFiledText:@"100"
                                                instructionsString:@"元"
                                                              type:@"0"
                                                        imageNamed:nil];
