...
- (void)configUI
{
    ...
    [centerButton setBackgroundImage:[UIImage wya_createImageWithColor:[UIColor whiteColor]]
    ...
    [bottomButton setBackgroundImage:[UIImage wya_createImageWithColor:[UIColor whiteColor]]
                            forState:UIControlStateNormal];
    ...
    [customIconButton setBackgroundImage:[UIImage wya_createImageWithColor:[UIColor whiteColor]]
                                forState:UIControlStateNormal];
    [customIconButton addCallBackAction:^(UIButton * button) {
        [UIView wya_showToastImage:@"icon_refresh"
                      autoRotation:NO
                         ImageType:WYAToastImageTypePNG
              sourceInWYAKitBundle:NO
                       autoDismiss:YES];
    }];
    ...
    customIconButton.frame          = CGRectMake(customIconButton_X, customIconButton_Y,
                                        customIconButton_Width, customIconButton_Height);
    ...
    successIconButton.frame          = CGRectMake(successIconButton_X, successIconButton_Y,
                                         successIconButton_Width, successIconButton_Height);
    ...
    [netFailButton setBackgroundImage:[UIImage wya_createImageWithColor:[UIColor whiteColor]]
                             forState:UIControlStateNormal];
    ...
    [loadingButton addCallBackAction:^(UIButton * button) {
        [UIView wya_toastWithMessage:@"正在加载"
                         imageString:@"spin_white"
                        autoRotation:YES
                           imageType:WYAToastImageTypeSVG
                sourceInWYAKitBundle:YES
                         autoDismiss:NO
            bgViewUserInteractionUse:YES];
