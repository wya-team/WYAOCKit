...
- (WYACustomSearchBar *)customSearchBar1
{
    if (!_customSearchBar1) {
        _customSearchBar1 = ({
            WYACustomSearchBar * object = [[WYACustomSearchBar alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(self.titleLabel1.frame) + 10, ScreenWidth - 20, 32)];
...
- (WYACustomSearchBar *)customSearchBar2
{
    if (!_customSearchBar2) {
        _customSearchBar2 = ({
            WYACustomSearchBar * object = [[WYACustomSearchBar alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(self.titleLabel2.frame) + 10, ScreenWidth - 20, 32)];
            object.delegate             = self;
...
- (WYACustomSearchBar *)customSearchBar3
{
    if (!_customSearchBar3) {
        _customSearchBar3 = ({
            WYACustomSearchBar * object = [[WYACustomSearchBar alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(self.titleLabel3.frame) + 10, ScreenWidth - 20, 32)];
            object.delegate             = self;
