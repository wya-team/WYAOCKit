...
- (UITextField *)textField2 {
    if (!_textField2) {
        _textField2 = ({
            UITextField * object = [[UITextField alloc]
                initWithFrame:CGRectMake(20 * SizeAdapter, WYATopHeight + 20 * SizeAdapter,
                                         ScreenWidth - 40 * SizeAdapter, 44 * SizeAdapter)];
...
- (UITextField *)textField1 {
    if (!_textField1) {
        _textField1 = ({
            UITextField * object = [[UITextField alloc]
                initWithFrame:CGRectMake(20 * SizeAdapter,
                                         CGRectGetMaxY(self.textField2.frame) + 20 * SizeAdapter,
                                         ScreenWidth - 40 * SizeAdapter, 44 * SizeAdapter)];
...
- (WYANumberKeyboard *)randomKeyboard {
    if (!_randomKeyboard) {
        _randomKeyboard = ({
            WYANumberKeyboard * object =
                [WYANumberKeyboard initRandomKeyboardWithTextFiled:self.textField2];
            object;
        });
    }
