...
{
    WYABannerView * cycleScrollView = [[self alloc] initWithFrame:frame];
...
+ (instancetype)wya_bannerViewWithFrame:(CGRect)frame imageURLStringsGroup:(NSArray *)imageURLsGroup
{
    WYABannerView *cycleScrollView = [[self alloc] initWithFrame:frame];
