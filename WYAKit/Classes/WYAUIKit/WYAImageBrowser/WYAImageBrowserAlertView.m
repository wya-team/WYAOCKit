...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        WeakSelf(weakSelf);
        [self wya_AddTapGesturesWithTapStyle:WYATapGesturesStyleSingle
...
- (WYAAlertButton *)cancelButton
{
    if (!_cancelButton) {
        _cancelButton = ({
            WYAAlertButton * object = [[WYAAlertButton alloc] initWithTitle:@"取消"
                                                                  titleFont:FONT(15)
                                                                 titleColor:[UIColor grayColor]
                                                                      image:nil
                                                            backgroundImage:[UIImage wya_createImageWithColor:[UIColor whiteColor]]
