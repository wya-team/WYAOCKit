...
- (UIButton *)deleteButton
{
    if (!_deleteButton) {
        _deleteButton = ({
            ...
            [object setImage:[UIImage loadBundleImage:@"icon_delete2" ClassName:NSStringFromClass(self.class)] forState:UIControlStateNormal];
            ...
            [object addTarget:self action:@selector(deleteButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
            object;
        });
    }
