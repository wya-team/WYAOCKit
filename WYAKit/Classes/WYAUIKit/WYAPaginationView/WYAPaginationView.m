...
- (UIButton *)leftButton {
    if (!_leftButton) {
        ...
        [_leftButton setBackgroundImage:[UIImage wya_createImageWithColor:[UIColor whiteColor]]
                               forState:UIControlStateNormal];
        [_leftButton setBackgroundImage:[UIImage wya_createImageWithColor:random(251, 251, 253, 1)]
...
- (UIButton *)rightButton {
    if (!_rightButton) {
        ...
        [_rightButton setBackgroundImage:[UIImage wya_createImageWithColor:[UIColor whiteColor]]
                                forState:UIControlStateNormal];
        [_rightButton setBackgroundImage:[UIImage wya_createImageWithColor:random(251, 251, 253, 1)]
                                forState:UIControlStateDisabled];
    }
    return _rightButton;
}
