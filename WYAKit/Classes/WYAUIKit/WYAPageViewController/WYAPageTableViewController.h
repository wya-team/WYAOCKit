...
typedef NS_ENUM(NSUInteger, WYAPageTableControllerPreloadPolicy) {
    ...
    WYAPageTableControllerPreloadPolicyNeighbour = 1, // Pre-load the controller next to the current.
 ...
 */
- (__kindof UIViewController *)wya_pageController:(WYAPageTableViewController *)pageController viewControllerAtIndex:(NSInteger)index;
 ...
 */
- (void)wya_pageController:(WYAPageTableViewController *)pageController lazyLoadViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
...
/**
 ...
 @param info  A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)wya_pageController:(WYAPageTableViewController *)pageController willCachedViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)wya_pageController:(WYAPageTableViewController *)pageController willEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
...
/**
 ...
 @param info A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)wya_pageController:(WYAPageTableViewController *)pageController didEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;

@end

@interface WYAPageTableViewController : UIViewController <WYAMenuViewDataSource, WYAMenuViewDelegate, UIScrollViewDelegate, WYAPageTableControllerDelegate, WYAPageTableControllerDataSource>
